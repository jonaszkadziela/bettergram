<?php
  ...
  try
  {
    ...
    {
      if ($connection->query("INSERT INTO photos_ratings VALUES ('$rating', '$photo_id', '$user_id')"))
      {
        $response = array('responseText' => 'Pomyślnie zapisano ocenę!', 'ratingResult' => render_rating($photo_id));
  ...
  {
    echo 'Wystąpił błąd #' . $e->getMessage() . ' podczas zapisywania oceny! Spróbuj ponownie później.';
    http_response_code(500);
    exit();
  }
?>
