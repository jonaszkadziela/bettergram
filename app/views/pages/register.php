      ...
      <div class="col-lg-8 m-auto">
        ...
        <div class="card p-1 shadow-lg">
          <div class="card-body text-center">
            <?php
              // Redirect user to the following URL after registration
              $_SESSION['redirect_url'] = ROOT_URL . '?page=welcome';
              include VIEWS_PATH . 'users/create_user_form.php';
            ?>
            <div class="mt-1-5 pt-0-5">
              <span class="text-muted">Posiadasz już konto?</span>
              <a class="underline underline--narrow underline-primary underline-animation" href="<?php echo ROOT_URL . modify_get_parameters(['page' => 'login']) ?>">Zaloguj się!</a>
            </div>
          </div>
        </div>
      </div>
