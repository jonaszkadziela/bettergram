<?php
  ...
  $query =
    ...
    WHERE
      p.id = pr.photo_id AND p.verified = 1
    GROUP BY
      p.id
    ORDER BY
      AVG(pr.rating)
      ...
      <div class="col-lg-12 col-xl-10 m-auto">
        ...
        <div class="card p-1 shadow-lg">
          <div class="card-body text-center">
            <?php
              echo '<h2 class="underline underline-primary mb-1-5">Najlepiej oceniane</h2>' . PHP_EOL;
              if (count($photos) > 0)
              {
                echo '<p class="text-muted pt-0-5 mb-1">Zestawienie 20 najlepiej ocenianych zdjęć</p>' . PHP_EOL;
